...
from backtest.optimizer.compare import *
from backtest.tools.ta import *
from datetime import datetime as dt


class BollStrategyTest(BacktestStrategyTest):
    def initialize(self):
        self.context.universe = ['OI801']
        self.context.run_info.strategy_name = 'boll30s-oi_main-stoploss0'
        self.context.run_info.feed_frequency = '1m'

        self.context.run_info.start_date = '2017-01-01'
        self.context.run_info.end_date = '2017-01-28'
